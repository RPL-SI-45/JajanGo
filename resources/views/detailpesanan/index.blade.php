            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample">
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nama Pesanan</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="exampleInputUsername2" placeholder="Seblak">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Jumlah</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="exampleInputMobile" placeholder="2">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Catatan</label>
                        <div class="col-sm-9">
                ...
                <div class="form-check form-check-flat form-check-primary">
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2">Pesan Sekarang</button>
