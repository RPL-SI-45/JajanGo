                ...
                <div class="row">
                    @foreach ($daftarmenu as $menu)
                        ...
                        <ul class="list-group list-group-flush">
                          <li class="list-group-item" style="background-color: #F6F5F2; text-align:center">Harga : {{  $menu->harga  }}</li>
                          <li class="list-group-item" style="background-color: #F6F5F2">Kategori : {{  $menu->kategoriMenu  }}</li>
                        </ul>
