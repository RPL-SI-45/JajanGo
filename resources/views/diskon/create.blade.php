                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../index.html">
                            <span class="menu-title">Buat Kode Promo</span>
                            <i class="mdi mdi-home menu-icon"></i>
                        </a>
                    <li class="nav-item">
                        <a class="nav-link" href="../../pages/icons/mdi.html">
                            <span class="menu-title">Riwayat Daftar Diskon</span>
                        ...
                        <div class="col-md-6 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample" action="/diskon/create/perform" method="POST">
                                    @csrf
                                <form class="forms-sample">
                                    <div class="form-group row">
                                        <label for="menuDropdown" class="col-sm-3 col-form-label">Nama Menu</label>
                                        <div class="col-sm-9">
